(function (global, factory) {
    ...
    var IconDirective = /** @class */ (function () {
        ...
        IconDirective.propDecorators = {
            icIcon: [{ type: core.Input }],
            icon: [{ type: core.Input }],
            color: [{ type: core.Input }],
            inline: [{ type: core.Input }, { type: core.HostBinding, args: ['class.ic-inline',] }],
            box: [{ type: core.Input }],
            size: [{ type: core.Input }, { type: core.HostBinding, args: ['style.font-size',] }],
            width: [{ type: core.Input }],
            height: [{ type: core.Input }],
            align: [{ type: core.Input }],
            hFlip: [{ type: core.Input }],
            vFlip: [{ type: core.Input }],
            flip: [{ type: core.Input }],
            rotate: [{ type: core.Input }],
            iconHTML: [{ type: core.HostBinding, args: ['innerHTML',] }]
        };
